...
import {
  BsChevronBarDown, BsFillArrowLeftSquareFill, BsSearch, BsCalendarCheckFill,
  BsBagCheckFill, BsStickiesFill, BsCreditCard2FrontFill
} from "react-icons/bs";
...
const Navbar = () => {
  ...
  return (
    <div className="flex">
      <div className={` bg-purple-950 p-5 pt-8 ${open ? "w-72" : "w-20"} duration-300  relative`}>
        ...
        <div className='inline-flex'>
          <img src={Ktda} alt="/" className={`text-4xl w-20 h-25 rounded cursor-pointer bg-lime-500 float-left mr-2 duration-500
        ${open && "rotate-[360deg]"}`} />
